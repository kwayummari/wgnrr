...
class allchoicesShimmerLoading extends StatefulWidget {
  ...
  allchoicesShimmerLoading({required this.width, required this.height, required this.commentwidth, required this.commentheight, required this.borderRadius});

  @override
  _allchoicesShimmerLoadingState createState() => _allchoicesShimmerLoadingState();
}
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Align(alignment: Alignment.topLeft, child: Icon(Icons.circle, color: Colors.grey.shade400,)),
        ),
        SizedBox(
          width: widget.width,
